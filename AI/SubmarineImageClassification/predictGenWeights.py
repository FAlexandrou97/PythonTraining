from keras.layers import Dense, Dropout, Flatten, Conv2D, BatchNormalization, Activation, MaxPooling2D, GaussianNoise, ZeroPadding2D
...
opt = Adam(lr=0.0001)
model.load_weights("weights-ocean-137-0.89.hdf5")
